import {parse}  from './mathSolverLogic'
...
describe('#parse', () => {
  ...
  describe('edge cases', () => {
    ...
    test('should return NaN when entry is not valid', () => {
      expect(parse('abc')).toEqual("Please use numbers and operators only.")
      expect(parse('1+2*sdfsdf')).toEqual("Please use numbers and operators only.")
      expect(parse('3*2=6')).toEqual("Please use numbers and operators only.")
    })
  })
})